...
const webAuth = new auth0.WebAuth({
    ...
    redirectUri: window.location.origin + import.meta.env.VITE_BASE_URL + "callback",
...
class AuthService extends EventEmitter {
    ...
    isAuthenticated() {
        ...
        //     localStorage.getItem(loggedInKey) === 'true'
        // );

        return (localStorage.getItem(userInfoKey) !== null && localStorage.getItem(loggedInKey) === 'true')
    }
}
